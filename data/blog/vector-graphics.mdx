---
title: 'Using vectors to make images that will never be blurry'
date: '2024-08-07'
lastmod: '2024-08-07'
tags: ['computer graphics', 'geometry', 'trigonometry', 'middle school', 'high school']
draft: false
summary: 'If you zoom too far into a JPG image it will be blurry.  There is another way to save images using math which will never be blurry no matter how far you zoom in!'
...
If you zoom too far into a JPG image (also known as raster) it will be blurry. There is another way to save images using math which will never be blurry no matter how far you zoom in!
