...
const siteMetadata = {
  ...
  mastodon: '',
  email: 'contact@rationalnumbers.org',
  ...
  analytics: {
    ...
    // },
    googleAnalytics: {
      googleAnalyticsId: 'G-8SBSPE182V', // e.g. G-XXXXXXX
    },
  },
  newsletter: {
    // supports mailchimp, buttondown, convertkit, klaviyo, revue, emailoctopus, beehive
    // Please add your .env file and modify it according to your selection
    //provider: 'buttondown', //MWS commented out to disable newsletter
  },
  comments: {
    // If you want to use an analytics provider you have to add it to the
    // content security policy in the `next.config.js` file.
    ...
    //provider: 'giscus', // supported providers: giscus, utterances, disqus //MWS commented out to disable comments
    giscusConfig: {
